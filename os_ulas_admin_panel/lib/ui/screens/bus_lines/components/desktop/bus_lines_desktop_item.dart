...
class BusLinesDesktopItem extends StatelessWidget {
  const BusLinesDesktopItem({super.key, required this.isDarkBackground});
          ...
          children: [
            ...
            Expanded(
              ...
              child: Padding(
                padding: AppPaddings.mediumVertical,
                child: Text(
                  'Lorem lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum',
                  style: Theme.of(context).textTheme.labelSmall,
                  overflow: TextOverflow.ellipsis,
                  textAlign: TextAlign.center,
                ),
